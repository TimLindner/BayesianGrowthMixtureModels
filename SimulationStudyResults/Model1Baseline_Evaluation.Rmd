...
# in R, data.frames store their data in column-major order.
```


# Color coding
* <span style="color: blueviolet;">blueviolet</span> for parameters of Normal distributions ( i.e., constant, linear trend component, and standard deviation )
...
# estimated data ####
# load model fit
m_fit <- readRDS("SimulationStudyResult/Model1Baseline_Dataset1_Fit1.rds")

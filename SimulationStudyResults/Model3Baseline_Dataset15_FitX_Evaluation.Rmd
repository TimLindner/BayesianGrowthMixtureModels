...
# required files:
# Dataset15_Yobs.xlsx
# Model3Baseline_Dataset15_Fit1.rds
```
...
# Hyperparameters
* $\beta_{0,\mu} = \log \frac{1}{N} \displaystyle\sum_{n=1}^{N} y^{obs}_{n,t=1}$
...
# estimated data ####
# load model fit
m_fit <- readRDS("SimulationStudyResults/Model3Baseline_Dataset15_Fit1.rds")

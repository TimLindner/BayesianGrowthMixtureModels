...
# Model1TwoClasses_IdentErr_SimCase16_Yobslog_SimRun1_Fit.rds
```
...
Y_obs_log <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/SimCase16_Yobslog_SimRun",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
z_sim <- data.frame(read_excel(
  paste("SimulationStudyData/Model3/SimCase16_zsim_SimRun",
        r,
        ".xlsx",
        sep = ""),
  sheet = "Sheet 1"))
...
paste_part_2 <- "Model1TwoClasses_IdentErr_SimCase16_Yobslog_SimRun"

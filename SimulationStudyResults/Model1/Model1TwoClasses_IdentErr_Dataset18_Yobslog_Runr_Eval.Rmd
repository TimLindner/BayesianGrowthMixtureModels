...
# Model1TwoClasses_IdentErr_Dataset18_Yobslog_Run1_Fit.rds
```
...
Y_obs_log <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/Dataset18_Yobslog_Run",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/Dataset18_Yobs_Run",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
paste_part_2 <- "Model1TwoClasses_IdentErr_Dataset18_Yobslog_Run"

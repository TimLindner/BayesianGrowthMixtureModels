...
# README
# required files:
# one of the following files from the SimulationStudyData/Model1 folder:
# SimCase1_Yobs_SimRun1.xlsx
# SimCase1_Yobs_SimRun2.xlsx
# SimCase1_Yobs_SimRun3.xlsx
# SimCase1_Yobs_SimRun4.xlsx
# SimCase1_Yobs_SimRun5.xlsx
# and the corresponding file from the SimulationStudyResults/Model1 folder:
# e.g., for the first file listed above,
# Model1Baseline_SimCase1_Yobs_SimRun1_Fit.rds
```
...
Y_obs <- data.frame(read_excel(
    paste(
      "SimulationStudyData/Model1/SimCase1_Yobs_SimRun", r, ".xlsx", sep = ""),
    sheet = "Sheet 1"))
...
# load model fit
m_fit <- readRDS(paste(
  "SimulationStudyResults/Model1/Model1Baseline_SimCase1_Yobs_SimRun",
  r,
  "_Fit.rds",
  sep = ""))

...
# Model1TwoClasses_IdentErr_SimCase17_Yobslog_SimRun1_Fit.rds
```
...
* $\boldsymbol{z}_n$ is a column vector of size $N$ indicating the class memberships
...
Y_obs_log <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/SimCase17_Yobslog_SimRun",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/SimCase17_Yobs_SimRun",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
z_sim <- data.frame(read_excel(
  paste("SimulationStudyData/Model3/SimCase17_zsim_SimRun",
        r,
        ".xlsx",
        sep = ""),
  sheet = "Sheet 1"))
...
paste_part_2 <- "Model1TwoClasses_IdentErr_SimCase17_Yobslog_SimRun"

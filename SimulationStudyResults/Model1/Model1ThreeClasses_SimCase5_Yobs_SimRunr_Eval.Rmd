...
# README
# required files:
# one of the following pairs of files from the SimulationStudyData/Model1
# folder:
# SimCase5_Yobs_SimRun1.xlsx, SimCase5_zsim_SimRun1.xlsx 
# SimCase5_Yobs_SimRun2.xlsx, SimCase5_zsim_SimRun2.xlsx
# SimCase5_Yobs_SimRun3.xlsx, SimCase5_zsim_SimRun3.xlsx
# SimCase5_Yobs_SimRun4.xlsx, SimCase5_zsim_SimRun4.xlsx
# SimCase5_Yobs_SimRun5.xlsx, SimCase5_zsim_SimRun5.xlsx
# and the corresponding file from the SimulationStudyResults/Model1 folder:
# e.g., for the first pair of files listed above,
# Model1ThreeClasses_SimCase5_Yobs_SimRun1_Fit.rds
```
...
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model1/SimCase5_Yobs_SimRun",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
z_sim <- data.frame(read_excel(
  paste(
    "SimulationStudyData/Model1/SimCase5_zsim_SimRun", r, ".xlsx", sep = ""),
  sheet = "Sheet 1"))
...
# load model fit
m_fit <- readRDS(paste(
  "SimulationStudyResults/Model1/Model1ThreeClasses_SimCase5_Yobs_SimRun",
  r,
  "_Fit.rds",
  sep = ""))
...
for (n in 1:N) {
  ...
  barplot(z_posterior[[n]],
          ...
          col = c("deepskyblue","blueviolet","darkblue"),
          border = FALSE,
          main = paste("Class membership for n =", n),
          names.arg = "",
          ylab = "Pr( z = c )",

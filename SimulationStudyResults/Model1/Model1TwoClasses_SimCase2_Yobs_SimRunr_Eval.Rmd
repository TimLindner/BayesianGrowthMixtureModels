...
# folder:
# SimCase2_Yobs_SimRun1.xlsx, SimCase2_zsim_SimRun1.xlsx 
# SimCase2_Yobs_SimRun2.xlsx, SimCase2_zsim_SimRun2.xlsx
# SimCase2_Yobs_SimRun3.xlsx, SimCase2_zsim_SimRun3.xlsx
# SimCase2_Yobs_SimRun4.xlsx, SimCase2_zsim_SimRun4.xlsx
# SimCase2_Yobs_SimRun5.xlsx, SimCase2_zsim_SimRun5.xlsx
# and the corresponding file from the SimulationStudyResults/Model1 folder:
# e.g., for the first pair of files listed above,
# Model1TwoClasses_SimCase2_Yobs_SimRun1_Fit.rds
```
...
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model1/SimCase2_Yobs_SimRun",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
z_sim <- data.frame(read_excel(
  paste(
    "SimulationStudyData/Model1/SimCase2_zsim_SimRun", r, ".xlsx", sep = ""),
  sheet = "Sheet 1"))
...
# load model fit
m_fit <- readRDS(paste(
  "SimulationStudyResults/Model1/Model1TwoClasses_SimCase2_Yobs_SimRun",
  r,
  "_Fit.rds",
  sep = ""))

...
# README
# required files:
# one of the following datasets from the SimulationStudyData/Model1 folder:
...
# e.g., for the first dataset listed above,
# Model1Baseline_Dataset1_Yobs_Run1.rds
```
...
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model1/Dataset1_Yobs_Run", r, ".xlsx", sep = ""),
    sheet = "Sheet 1"))

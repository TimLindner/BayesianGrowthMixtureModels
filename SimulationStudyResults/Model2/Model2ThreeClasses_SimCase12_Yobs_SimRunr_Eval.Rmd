...
# README
# required files:
# one of the following pairs of files from the SimulationStudyData/Model2
# folder:
# SimCase12_Yobs_SimRun1.xlsx, SimCase12_zsim_SimRun1.xlsx 
# SimCase12_Yobs_SimRun2.xlsx, SimCase12_zsim_SimRun2.xlsx
# SimCase12_Yobs_SimRun3.xlsx, SimCase12_zsim_SimRun3.xlsx
# SimCase12_Yobs_SimRun4.xlsx, SimCase12_zsim_SimRun4.xlsx
# SimCase12_Yobs_SimRun5.xlsx, SimCase12_zsim_SimRun5.xlsx
# and the corresponding file from the SimulationStudyResults/Model2 folder:
# e.g., for the first pair of files listed above,
# Model2ThreeClasses_SimCase12_Yobs_SimRun1_Fit.rds
```
...
* $\boldsymbol{\beta}_2$ is a row vector of size $C$ representing the quadratic trend components
...
* $\sigma_{\beta_{1,c}} = 0.5$

* $\mu_{\beta_{2,c}} = 0$

* $\sigma_{\beta_{2,c}} = 0.5$
...
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model2/SimCase12_Yobs_SimRun",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
z_sim <- data.frame(read_excel(
  paste("SimulationStudyData/Model2/SimCase12_zsim_SimRun",
        r,
        ".xlsx",
        sep = ""),
  sheet = "Sheet 1"))
...
paste_part_1 <- "SimulationStudyResults/Model2/"
paste_part_2 <- "Model2ThreeClasses_SimCase12_Yobs_SimRun"
...
```{r}
# trace plots for quadratic trend components
for (c in 1:C) {
  plot(m_fit_data$beta_2[,c],
       type = "l",
       col = "blueviolet",
       main = "",
       xlab = "",
  ...
  plot(m_fit_data$beta_2[,c],
       type = "l",
       col = "blueviolet",
       main = paste("Quadratic trend component for c =", c),
       xlab = "Sampling iteration",
       ylab = "beta_1")
...
for (c in 1:C) {
  hist(m_fit_data$beta_2[,c],
       xlim = c(min(m_fit_data$beta_2[,c],beta_2_sim[c]),
                max(m_fit_data$beta_2[,c],beta_2_sim[c])),
       col = "blueviolet",
       border = FALSE,
       main = "",
       xlab = "")

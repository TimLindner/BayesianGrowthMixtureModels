...
# Hyperparameters
* $\boldsymbol{\beta}_{0,\mu} = \boldsymbol{\kappa} \text{, where } \boldsymbol{\kappa} \text{ is a row vector of size } C \text{ storing the estimates of K-means clustering for } \boldsymbol{y}^{obs}_{t=1} \text{, with } \kappa_c \leq \kappa_{c+1}$

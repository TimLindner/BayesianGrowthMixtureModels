...
# - Model1Baseline_Dataset1_Fit.rds ( default )
# - Model1Baseline_Dataset2_Fit.rds
# - Model1Baseline_Dataset3_Fit.rds
```
...
# estimated data ####
# load model fit
m_fit <- readRDS("SimulationStudyResults/Model1TwoClasses_Dataset2_Fit.rds")
...
plot(m_fit_params$sigma,
     type = "l",
     col = "blueviolet",
     main = "Standard deviation of Y Normal distributions",
     xlab = "Sampling iteration",
     ylab = "sigma")

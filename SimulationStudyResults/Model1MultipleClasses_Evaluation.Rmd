...
# - Dataset2_Yobs.xlsx, Dataset2_zsim ( default )
# - Dataset3_Yobs.xlsx, Dataset3_zsim
# - Dataset4_Yobs.xlsx, Dataset4_zsim
...
Rhat_ESS <-
  as.data.frame(monitor(extract(m_fit, permuted = FALSE)))[,diagnostics]
# [params,diagnostics]
```

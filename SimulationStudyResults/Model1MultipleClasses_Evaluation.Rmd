...
# Hyperparameters
* $\beta_{0,c=1,\mu} = min\{\boldsymbol{y}^{obs}_{t=1}\} + \frac{max\{\boldsymbol{y}^{obs}_{t=1}\} - min\{\boldsymbol{y}^{obs}_{t=1}\}}{2} - 2$

* $\beta_{0,c=2,\mu} = min\{\boldsymbol{y}^{obs}_{t=1}\} + \frac{max\{\boldsymbol{y}^{obs}_{t=1}\} - min\{\boldsymbol{y}^{obs}_{t=1}\}}{2} + 2$
...
# estimated data ####
# load model fit
m_fit <- readRDS("SimulationStudyResults/Model1TwoClasses_Dataset2_Fit1_NoWarnings.rds")

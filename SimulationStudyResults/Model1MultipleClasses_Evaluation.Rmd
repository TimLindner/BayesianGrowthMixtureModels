...
# Hyperparameters
* $\beta_{0,c=1,\mu} = min\{\boldsymbol{\kappa}\} \text{, where } \boldsymbol{\kappa} \text{ stores the estimates of K-means clustering with two clusters for } \boldsymbol{y}^{obs}_{t=1}$

* $\beta_{0,c=1,\mu} = max\{\boldsymbol{\kappa}$

...
# Hyperparameters
* $\beta_{0,c=1,\mu} = min\{\boldsymbol{y}^{obs}_{t=1}\} + \frac{max\{\boldsymbol{y}^{obs}_{t=1}\} - min\{\boldsymbol{y}^{obs}_{t=1}\}}{2} - 3$

* $\beta_{0,c=2,\mu} = min\{\boldsymbol{y}^{obs}_{t=1}\} + \frac{max\{\boldsymbol{y}^{obs}_{t=1}\} - min\{\boldsymbol{y}^{obs}_{t=1}\}}{2} + 3$

...
# README
# required files:
# one of the following pairs of datasets:
# - Dataset2_Yobs.xlsx, Dataset2_zsim.xlsx ( default )
# - Dataset3_Yobs.xlsx, Dataset3_zsim.xlsx
# - Dataset4_Yobs.xlsx, Dataset4_zsim.xlsx
# - Dataset5_Yobs.xlsx, Dataset5_zsim.xlsx
# - Dataset6_Yobs.xlsx, Dataset6_zsim.xlsx
# and the corresponding model fit:
# - Model1TwoClasses_Dataset2_Fit1.rds ( default )
# - Model1TwoClasses_Dataset3_Fit1.rds
# - Model1TwoClasses_Dataset4_Fit1.rds
# - Model1ThreeClasses_Dataset5_Fit1.rds
...
# Hyperparameters
* $\boldsymbol{\beta}_{0,\mu} = \boldsymbol{\kappa}\text{,}$ where $\boldsymbol{\kappa}$ is a row vector of size $C$ storing the estimates of K-means clustering for $\boldsymbol{y}^{obs}_{t=1}$, with $\kappa_c \leq \kappa_{c+1}$; K-means clustering is performed using the algorithm of Hartigan and Wong (1979) with maximum ten iterations and one random set
...
z_sim <- data.frame(read_excel("SimulationStudyData/Dataset2_zsim.xlsx",
                               sheet = "Sheet 1"))
...
# estimated data ####
# load model fit
m_fit <- readRDS("SimulationStudyResults/Model1TwoClasses_Dataset2_Fit1.rds")

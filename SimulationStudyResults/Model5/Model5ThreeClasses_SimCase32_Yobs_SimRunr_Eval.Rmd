...
# folder:
# SimCase32_Yobs_SimRun1.xlsx, SimCase32_Zsim_SimRun1.xlsx 
# SimCase32_Yobs_SimRun2.xlsx, SimCase32_Zsim_SimRun2.xlsx
# SimCase32_Yobs_SimRun3.xlsx, SimCase32_Zsim_SimRun3.xlsx
# SimCase32_Yobs_SimRun4.xlsx, SimCase32_Zsim_SimRun4.xlsx
# SimCase32_Yobs_SimRun5.xlsx, SimCase32_Zsim_SimRun5.xlsx
# and the corresponding file from the SimulationStudyResults/Model5 folder:
# e.g., for the first pair of files listed above,
# Model5ThreeClasses_SimCase32_Yobs_SimRun1_Fit.rds
```
...
* Initial values for $\boldsymbol{\beta_1}$: $(-0.5,0.5,1)$
...
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model5/SimCase32_Yobs_SimRun",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
Psi_sim[1,] <- c(0.95,0.02,0.03)
Psi_sim[2,] <- c(0,0.99,0.01)
Psi_sim[3,] <- c(0.04,0.06,0.90)

# load simulated class memberships
Z_sim <- data.frame(read_excel(
  paste(
    "SimulationStudyData/Model5/SimCase32_Zsim_SimRun", r, ".xlsx", sep = ""),
  sheet = "Sheet 1"))
...
paste_part_2 <- "Model5ThreeClasses_SimCase32_Yobs_SimRun"
...
params <- c("omega[1]","omega[2]","omega[3]",
            "Psi[1,1]","Psi[1,2]","Psi[1,3]",
            "Psi[2,1]","Psi[2,2]","Psi[2,3]",
            "Psi[3,1]","Psi[3,2]","Psi[3,3]",

...
* Initial values for $\beta_{0,c}$: $\kappa_c$ for every chain
...
z_sim <- data.frame(read_excel("SimulationStudyData/Dataset5_zsim.xlsx",
                               sheet = "Sheet 1"))
...
# estimated data ####
# load model fit
m_fit <- readRDS("SimulationStudyResults/Model1ThreeClasses_Dataset5_Fit1.rds")

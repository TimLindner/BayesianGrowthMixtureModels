...
# Model1TwoClasses_IdentErr_Dataset17_Yobslog_Run1.rds
```
...
* $\sigma_{\beta_{0,c}} = 0.05$

* $\mu_{\beta_{1,c}} = 0$

* $\sigma_{\beta_{1,c}} = 0.1$
...
Y_obs_log <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/Dataset17_Yobslog_Run",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/Dataset17_Yobs_Run",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
paste_part_2 <- "Model1TwoClasses_IdentErr_Dataset17_Yobslog_Run"
...
# Convergence
```{r, include = FALSE}
# diagnostics: Rhat, Bulk ESS, and Tail ESS

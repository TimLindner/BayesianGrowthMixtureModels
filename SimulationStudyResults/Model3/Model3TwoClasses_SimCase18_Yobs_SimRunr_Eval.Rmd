...
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/Dataset18_Yobs_Run", r, ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
z_sim <- data.frame(read_excel(
  paste("SimulationStudyData/Model3/Dataset18_zsim_Run", r, ".xlsx", sep = ""),
  sheet = "Sheet 1"))
...
paste_part_2 <- "Model3TwoClasses_Dataset18_Yobs_Run"

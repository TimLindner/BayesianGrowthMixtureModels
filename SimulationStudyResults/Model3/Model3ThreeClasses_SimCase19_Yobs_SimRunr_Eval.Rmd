...
# Model3ThreeClasses_SimCase19_Yobs_SimRun1_Fit.rds
```
...
z_sim <- data.frame(read_excel(
  paste(
    "SimulationStudyData/Model3/SimCase19_zsim_SimRun", r, ".xlsx", sep = ""),
  sheet = "Sheet 1"))
...
# load model fit
m_fit <- readRDS(paste(
  "SimulationStudyResults/Model3/Model3ThreeClasses_SimCase19_Yobs_SimRun",
  r,
  "_Fit.rds",
  sep = ""))

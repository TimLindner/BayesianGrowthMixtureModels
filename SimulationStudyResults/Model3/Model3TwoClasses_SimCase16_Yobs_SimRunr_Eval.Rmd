...
# folder:
# SimCase16_Yobslog_SimRun1.xlsx, SimCase16_zsim_SimRun1.xlsx
# SimCase16_Yobslog_SimRun2.xlsx, SimCase16_zsim_SimRun2.xlsx
# SimCase16_Yobslog_SimRun3.xlsx, SimCase16_zsim_SimRun3.xlsx
# SimCase16_Yobslog_SimRun4.xlsx, SimCase16_zsim_SimRun4.xlsx
# SimCase16_Yobslog_SimRun5.xlsx, SimCase16_zsim_SimRun5.xlsx
# and the corresponding file from the SimulationStudyResults/Model3 folder:
# e.g., for the first pair of files listed above,
# Model3TwoClasses_SimCase16_Yobs_SimRun1_Fit.rds
```
...
Y_obs <- data.frame(read_excel(
    paste("SimulationStudyData/Model3/SimCase16_Yobs_SimRun",
          r,
          ".xlsx",
          sep = ""),
    sheet = "Sheet 1"))
...
z_sim <- data.frame(read_excel(
  paste(
    "SimulationStudyData/Model3/SimCase16_zsim_SimRun", r, ".xlsx", sep = ""),
  sheet = "Sheet 1"))
...
paste_part_2 <- "Model3TwoClasses_SimCase16_Yobs_SimRun"

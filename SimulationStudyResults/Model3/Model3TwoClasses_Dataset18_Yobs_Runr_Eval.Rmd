...
# README
# required files:
# one of the following pairs of datasets from the SimulationStudyData/Model3
# folder:
# Dataset18_Yobslog_Run1.xlsx, Dataset18_zsim_Run1.xlsx
# Dataset18_Yobslog_Run2.xlsx, Dataset18_zsim_Run2.xlsx
# Dataset18_Yobslog_Run3.xlsx, Dataset18_zsim_Run3.xlsx
# Dataset18_Yobslog_Run4.xlsx, Dataset18_zsim_Run4.xlsx
# Dataset18_Yobslog_Run5.xlsx, Dataset18_zsim_Run5.xlsx
# and the corresponding model fit from the SimulationStudyResults/Model3 folder:
# e.g., for the first pair of datasets listed above,
# Model3TwoClasses_Dataset18_Yobs_Run1_Fit.rds
```
...
* Initial values for $\beta_{0,c}$ and $\beta_{1,c}$: for every chain, the posterior means for $\beta_{0,c}$ and $\beta_{1,c}$ estimated via model 1 with identically distributed errors not only over individuals and time periods but also latent classes; posterior means estimated in run 1

...
# README
# required files:
# one of the following files from the SimulationStudyData/Model3 folder:
# SimCase15_Yobs_SimRun1.xlsx
# SimCase15_Yobs_SimRun2.xlsx
# SimCase15_Yobs_SimRun3.xlsx
# SimCase15_Yobs_SimRun4.xlsx
# SimCase15_Yobs_SimRun5.xlsx
# and the corresponding file from the SimulationStudyResults/Model3 folder:
# e.g., for the first file listed above,
# Model3Baseline_SimCase15_Yobs_SimRun1_Fit.rds
```
...
# Hyperparameters
* $\mu_{\beta_0} = \log\Bigg(\frac{1}{N} \displaystyle\sum_{n=1}^{N} y^{obs}_{n,t=1}\Bigg)$
...
Y_obs <- data.frame(read_excel(
    paste(
      "SimulationStudyData/Model3/SimCase15_Yobs_SimRun", r, ".xlsx", sep = ""),
    sheet = "Sheet 1"))
...
# load model fit
m_fit <- readRDS(paste(
  "SimulationStudyResults/Model3/Model3Baseline_SimCase15_Yobs_SimRun",
  r,
  "_Fit.rds",
  sep = ""))

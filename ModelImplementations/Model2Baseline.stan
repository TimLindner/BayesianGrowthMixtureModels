...
// vectors. thus, Y_obs, X, X_squared, and M are declared as one-dimensional arrays of row
// vectors.
...
data {
  ...
  // mean hyperparameter for Normal prior of quadratic trend component
  real mu_beta_2;
  
  // SD hyperparameter for Normal prior of quadratic trend component
...
transformed parameters {
  ...
  for (n in 1:N) {
    M[n] = beta_0 + beta_1 * X[n] + beta_2 * X_squared[n];
...
model {
  ...
  // prior for beta_2
  beta_2 ~ normal(mu_beta_2, sigma_beta_2);

...
m1_base_fit <- readRDS("SimulationStudyResult/Model1Baseline_Fit.rds")
m1_base_fit_params <- rstan::extract(m1_base_fit)

# middle 90% credible intervals for Y_pred
Y_pred <- m1_base_fit_params$Y_pred
...
## Constant
```{r}
plot(m1_base_fit_params$beta_0,
     type = "l",
     col = "blueviolet",
     main = "",
     xlab = "",
...
## Linear trend component
```{r}
plot(m1_base_fit_params$beta_1,
     type = "l",
     col = "blueviolet",
     main = "",
     xlab = "",
...
plot(m1_base_fit_params$sigma,
     type = "l",
     col = "blueviolet",
     main = "Standard deviation for Normal pdfs",
     xlab = "Sampling iteration",
     ylab = "sigma")
```
...
## Constant
```{r}
hist(m1_base_fit_params$beta_0,
     col = "blueviolet",
     border = FALSE,
     main = "",
     xlab = "")
...
## Linear trend component
```{r}
hist(m1_base_fit_params$beta_1,
     col = "blueviolet",
     border = FALSE,
     main = "",
     xlab = "")
...
for (n in 1:N) {
  ...
  plot(x = x,
       ...
       type="l",
       col = "white",
       main = paste("Middle 90% credible interval for n = ", n, sep = ""),

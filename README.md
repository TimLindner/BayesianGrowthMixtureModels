...
* :file_folder: ModelImplementation contains the Stan implementation for each model specified in :page_facing_up: ModelSpecification. In addition, the folder contains the Stan implementation of the corresponding baseline model ( baseline here refers to the assumption that only one class exists ).

...
* :file_folder: ModelImplementation contains two Stan implementation files for each model specified in ModelSpecification: the implementation of a baseline model, which assumes one class, and the implementation of a model, which assumes multiple classes.

...
- [ ] Comparison strategy for Normal vs Poisson (model comparison metrics per simulation run: Bayes factor and root mean squared error (over all sampling iterations))

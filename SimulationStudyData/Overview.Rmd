...
$\text{For } n \text{ in } 1,...,50 \text{ and } t \text{ in } 0,...,9\text{:}$
...
$\text{For } n \text{ in } 1,...,200 \text{ and } t \text{ in } 0,...,9\text{:}$

* $\boldsymbol{y}^{obs}_{n} \sim Normal(-5 - 0.5 \, \boldsymbol{x}_{n},0.75) \quad \text{if } z_n = 1$

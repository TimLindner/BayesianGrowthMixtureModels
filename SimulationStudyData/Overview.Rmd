...
```{r, include = FALSE}
# README
# required files from SimulationStudyData folder:
...
for (r in 1:R) {
  ...
  Y_obs <- data.frame(read_excel(paste("Dataset1_Yobs_Run", r, ".xlsx",
                                       sep = ""),
                                 sheet = "Sheet 1"))
...
```{r}
# load observed dependent variable
Y_obs <- data.frame(read_excel("Dataset3_Yobs.xlsx", sheet = "Sheet 1"))
...
```{r}
# load observed dependent variable
Y_obs <- data.frame(read_excel("Dataset4_Yobs.xlsx", sheet = "Sheet 1"))
...
```{r}
# load observed dependent variable
Y_obs <- data.frame(read_excel("Dataset5_Yobs.xlsx", sheet = "Sheet 1"))
...
```{r}
# load observed dependent variable
Y_obs <- data.frame(read_excel("Dataset6_Yobs.xlsx", sheet = "Sheet 1"))
...
```{r}
# load observed dependent variable
Y_obs <- data.frame(read_excel("Dataset15_Yobs.xlsx", sheet = "Sheet 1"))
...
```{r}
# load observed dependent variable
Y_obs <- data.frame(read_excel("Dataset16_Yobs.xlsx", sheet = "Sheet 1"))
Y_obs_log <- data.frame(read_excel("Dataset16_Yobslog.xlsx", sheet = "Sheet 1"))
...
for (r in 1:R) {
  ...
  # load observed dependent variable
  Y_obs <- data.frame(read_excel(paste("Dataset17_Yobs_Run", r, ".xlsx",
                                       sep = ""),
                                 sheet = "Sheet 1"))
  Y_obs <- data.frame(read_excel(paste("Dataset17_Yobslog_Run", r, ".xlsx",
                                       sep = ""),
                                 sheet = "Sheet 1"))
